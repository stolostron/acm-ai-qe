...
- `${SKILLS_DIR}/test-case-gen/acm-test-case-writer/SKILL.md` -- Writing methodology: step granularity rule, backend validation placement, implementation detail translation, self-review checklist, critical rules, gotchas
