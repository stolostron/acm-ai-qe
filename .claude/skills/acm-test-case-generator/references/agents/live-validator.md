...
- `${CLAUDE_SKILL_DIR}/../acm-cluster-health/SKILL.md` -- 12-layer diagnostic model, oc CLI patterns (MCH namespace discovery, foundational health, infra guards), MCP tool reference (acm-search, acm-kubectl)
