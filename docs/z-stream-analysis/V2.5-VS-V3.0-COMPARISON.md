...
| ACM-Source queries executed | 1 | 2 | +1 |
...
| `investigation_hints` | Yes | Yes | Identical content (removed in v4.0) |
...
| `ai_instructions` | Yes | Yes | Identical content (removed in v4.0) |
...
| 8. Investigation hints | `_build_investigation_hints()` | `_build_investigation_hints()` | Unchanged (removed in v4.0) |
...
| v2.5 used MCP tool | `mcp__acm-source__search_translations` | — |
...
|---|------|-------|---------|--------|
| 1 | `mcp__acm-source__search_translations` | `managed.createClusterSet (exact)` | Yes | Translation is 'Create cluster set' — test regex expects 'Create ClusterSet' |
...
| # | Tool | Query | Success | Result |
|---|------|-------|---------|--------|
| 1 | `mcp__acm-source__search_code` | `export-search-result in acm console repo` | Yes | Found in AcmTableToolbar.tsx:529 |
| 2 | `mcp__acm-source__search_code` | `OUIA-Generated-DropdownItem in acm console repo` | Yes | Not found — auto-generated by PF at runtime |
...
|--------|-------------|-------------|--------|
| ACM-Source (`mcp__acm-source__*`) | 1 (`search_translations`) | 2 (`search_code` x2) | +1, different tools used |
...
|--------|----------------|-----------|-----------|
| ACM-Source | 18 | 1 (5%) | 2 (10%) |
| JIRA | 24 | 3 (12.5%) | 0 (0%) |
| Neo4j RHACM | 2 | 0 (0%) | 0 (0%) |
