...
| 4 | Individual Test Failures | `per_test_analysis[]` — classification, confidence, error, reasoning, evidence, recommended fix, `failure_mode_category` (v3.3), `assertion_analysis` (v3.3) |
