...
Follow the console auth procedure in `${CLAUDE_SKILL_DIR}/../acm-test-case-generator/references/console-auth.md`. If that sibling is unavailable, use the inline minimum procedure in [environment-checks.md](references/environment-checks.md) section 10.
