...
2. Read `${KNOWLEDGE_DIR}/data-flow/<area>/data-flow.md` -- data flow through the subsystem
...
For each detected area, read `${KNOWLEDGE_DIR}/failures/<area>/failure-signatures.md`. Match error messages against known signatures. Record matched patterns with their classification hints.
