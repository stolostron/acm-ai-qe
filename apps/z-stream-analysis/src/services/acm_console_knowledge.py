...
class ACMConsoleKnowledge:
    ...
    # build_element_inventory and get_investigation_hints_with_mcp removed in v4.0.
    # Element verification is handled by the data-collector agent (Task 2) via MCP.
    # Investigation hints removed — static reference data was eliminated in v4.0.
