...
2. **Read ALL comments** -- they contain implementation decisions, edge cases, design trade-offs, QE feedback.

3. **Find linked tickets** using JQL patterns from acm-jira-client:
...
5. **Check existing Polarion coverage** using Polarion MCP tools from acm-polarion-client.
