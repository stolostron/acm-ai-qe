...
- `${SKILLS_DIR}/test-case-gen/acm-qe-code-analyzer/SKILL.md` -- PR analysis methodology, coverage gap rules, critical rules (full source reads, test file distinction, multi-story PRs)
...
- Cross-reference with area knowledge (`.claude/knowledge/ui/<area>.md`) if accessible. Flag contradictions.
