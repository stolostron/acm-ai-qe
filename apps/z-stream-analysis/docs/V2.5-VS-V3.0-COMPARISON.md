...
Collected by `ClusterInvestigationService` during Step 4b. Provides cluster-wide health context before per-test analysis begins.
...
| `per_test_analysis` | Yes | Yes | v3.0 adds 3 new fields per test |
| `summary` | Yes | Yes | Same structure, minor confidence difference |
