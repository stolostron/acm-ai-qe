...
class TestZStreamClusterDiagnosisContent:
    ...
    The in-skill reference must port the app's health-score formula VERBATIM from
    apps/z-stream-analysis/.claude/agents/cluster-diagnostic.md:699-703. The 5 penalty
