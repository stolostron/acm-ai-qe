...
4. **Cross-reference with area knowledge.** If `${SKILLS_DIR}/../knowledge/ui/<area>.md` contains field order, filtering behavior, or component structure information, verify that your analysis is consistent. If you find a conflict between your diff analysis and the knowledge file, flag it explicitly.
