...
17 portable skills, flat layout. Each has a `SKILL.md` entry point (YAML frontmatter + instructions). Shared skills are stateless tools; orchestrators compose them into pipelines.
