...
- `${SKILLS_DIR}/test-case-gen/acm-test-case-reviewer/SKILL.md` -- Full review process: structural validation, MCP verification (min 3), AC vs implementation check, knowledge cross-reference, design efficiency check, coverage gap verification
- `${SKILLS_DIR}/shared/acm-knowledge-base/SKILL.md` -- Knowledge file locations (conventions, architecture, examples)
