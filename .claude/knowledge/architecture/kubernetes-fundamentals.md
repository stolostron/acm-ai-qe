...
hub cluster and classify test failures. Prioritizes mechanisms over
...
## 3. Pod Lifecycle and Failure Modes

### Phases

- **Pending:** Accepted but not scheduled or images not pulled.
  Waiting for scheduling (resource constraints, node affinity).
- **Running:** At least one container running and passing probes
...
## 14. Secrets and Certificate Rotation
